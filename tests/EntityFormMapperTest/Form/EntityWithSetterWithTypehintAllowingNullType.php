...
class EntityWithSetterWithTypehintAllowingNullType extends AbstractType implements DataMapperInterface
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => EntityWithSetterWithTypehintAllowingNull::class,
            'empty_data' => null,
        ));
    }
    ...
    {
            return 'entity_with_setter_with_typehint_allowing_null';
    }
