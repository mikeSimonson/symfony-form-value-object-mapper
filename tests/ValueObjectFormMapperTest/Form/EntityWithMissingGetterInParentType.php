...
use MikeSimonson\ValueObjectFormMapperTest\Entity\EntityWithMissingGetterInParent;
...
class EntityWithMissingGetterType extends AbstractType implements DataMapperInterface
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => EntityWithMissingGetterInParent::class,
            'empty_data' => null,
        ));
    }
    ...
    {
            return 'entity_with_missing_getter';
    }
