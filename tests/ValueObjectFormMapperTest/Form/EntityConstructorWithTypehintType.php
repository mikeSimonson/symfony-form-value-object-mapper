...
class EntityConstructorWithTypehintType extends AbstractType implements DataMapperInterface
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => EntityConstructorWithTypehint::class,
            'empty_data' => null,
        ));
    }
    ...
    {
            return 'entity_constructor_with_typehint';
    }
